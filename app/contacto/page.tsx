...
const ContactPage: React.FC = () => {
  return (
    <>
      ...
      <main>
        <div
          className=" pr-[120px] bg-left-top bg-no-repeat w-full flex gap-8 justify-center items-center"
        ...
        >
          <iframe
            ...
            loading="lazy"
            className="h-[500px] w-full lg:w-[60%] lg:h-[80%]"
          />

          <div className="flex flex-col gap-4 mt-4 text-black h-[80%] justify-start ">
